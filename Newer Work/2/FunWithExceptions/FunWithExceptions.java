...
public class FunWithExceptions
{
   public static void main (String[] args) throws StringTooLongException, NoEvenNumberException
   {
	   ...
	   Random rand = new Random();
      	...
      	// be caught if raised
	   StringTooLongException lengthException = new StringTooLongException("String has too many chatacters");
	   ...
	   do
	   {
		   ...
		   input = JOptionPane.showInputDialog(null, "Please enter a string. Enter DONE " +
				   "when finished.");
		   
		   		// this string will be attempted to be processed
		   if (!input.equalsIgnoreCase("DONE"))
			   	try
		   		{
				   	// string too longthrow exception
				   if (input.length() > MAX)
				   {
				   ...
				   {
					   JOptionPane.showMessageDialog(null, "You entered: \"" + input + "\", its length was " +
							   input.length(), "String info", JOptionPane.INFORMATION_MESSAGE);
				   }	// end else statement
				   ...
				   System.out.println("num is: " + num);
				   		...
				   		// number is an even number throw exception!
				   if (num % 2 == 0)
				   {
		   		...
		   		// keep processing strings and numbers until is finished
		   
	   } while (!input.equalsIgnoreCase("DONE"));
	   
	   JOptionPane.showMessageDialog(null, "This program name was written by " + name + 
