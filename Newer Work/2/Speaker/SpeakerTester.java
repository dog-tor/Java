...
public class SpeakerTester {
	...
	public static void main(String[] args) {
		...
		((Philosopher) aristotle).pontificate(); // cast it to force java to use Philosopher class.
		...
		JOptionPane.showMessageDialog(null, "This program was written by dog-tor." +
				"\nEnd of program.");
