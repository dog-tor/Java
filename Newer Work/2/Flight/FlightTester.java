...
public class FlightTester {
	...
	public static void main(String[] args) throws Exception {
		...
		Flight allFlights[] = new Flight[5];
			...
			// data file and read it in
		fileText = JOptionPane.showInputDialog(null, "Please enter the data file name: ");
		...
		JOptionPane.showMessageDialog(null, "Number " + number + "" + " flight will be changed.");
		...
		JOptionPane.showMessageDialog(null, "New flight info for number " + number + "\n\n" + output);
