...
public class PlayWithNumbers {
    ...
    enum IceCream { chocolate, vanilla, strawberry, cream_in_cookies, 
    				neopolitan, banana_nut };
	...
	public static void main(String[] args) {
	      ...
	      String valueText;
	      String name = "dog-tor"; // replace with your name
	      Boolean inValid = true;
	      
	      	// prompt and read in an integer number
		 valueText = JOptionPane.showInputDialog(null, "Please enter your Banner number.");
		 	// convert to integer
		 ...
		 do 
		 {
			 ...
			 else // entered an non-zero value
			 {
				 inValid = false;
			 }
		 ...
		 System.out.println("Your earnings are: " + fmt1.format(earnings));
	...
	static void determinePay(int answer, double earnings)
	{
		int type;
		 ...
		 if (answer == YES)
		 {
			 ...
			 System.out.println("With " + fmt2.format(CHARITY) + " charity deductions, your earnings are: " + fmt1.format(earnings));
			 type = gen.nextInt(6);
			 ...
			 switch (type)
			 {
			 	...
			 	case 5: typeIceCream = IceCream.banana_nut; break;
			 	default: System.out.println("Error in type of ice cream.");
			 				System.exit(0);
			 } // end switch statement
			 
			 System.out.println("For your generosity you will get " + typeIceCream + " ice cream!");
		 }
